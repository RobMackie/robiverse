...
// rmackie const bool Z_MIN_ENDSTOP_INVERTING = false; //ACTIVO set to true to invert the logic of the endstop.
const bool Z_MIN_ENDSTOP_INVERTING = true; //ACTIVO set to true to invert the logic of the endstop.
